        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-10 text-sm">
            <div className="flex items-center gap-6">
              <span className="hidden md:block">🏠 Your Trusted Home Decor Resource Since 2015</span>
            </div>
            <div className="flex items-center gap-4">
              ...
              <a href="#" className="hover:text-blue-300 transition-colors" aria-label="Pinterest">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex justify-between items-center h-20">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500 hidden md:block">Home Decor & Design</div>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-8">
            ...
            <button className="hidden md:block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm">
              Subscribe
            </button>
          </div>
        </div>
